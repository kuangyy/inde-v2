...
<div class="container">
    ...
    <ol class="breadcrumb">
        <c:forEach var="tags" items="${hotTagList}" varStatus="varStatus">
            <li class="breadcrumb-item">${tags.name} </li>
        </c:forEach>
    </ol>
        <div class="">

            <c:forEach var="book" items="${bookModelList}" varStatus="varStatus">
                ...
                <div class="card">
                    ...
                    <div class="card-block">
                        <a href="${ctx}/b/${book.id}" target="_blank">
                            <h4 class="card-title" title="${book.name}">
                                <c:choose>
