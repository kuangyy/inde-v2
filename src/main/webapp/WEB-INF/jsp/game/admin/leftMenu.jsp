...
<div class="container"><a href="#" data-activates="nav-mobile" class="button-collapse top-nav full hide-on-large-only"><i class="fa fa-navicon" aria-hidden="true"></i></a></div>
...
<ul id="nav-mobile" class="side-nav fixed" >
    ...
    <li class="search">
        <div class="search-wrapper card">
            <input id="search"><i class="fa fa-search material-icons" aria-hidden="true"></i>
            <div class="search-results"></div>
        </div>
    </li>

    <li class="bold"><a href="#" class="waves-effect waves-teal active">设置</a></li>
